...
\documentclass[10pt,a4paper]{ctexart} % 10pt font size, A4 paper

\usepackage[top=2cm,bottom=1.5cm,left=1.7cm,right=1.7cm,columnsep=30pt]{geometry} % Document margins and spacings
...
\usepackage[center]{titlesec} % Required for modifying section titles - bold, sans-serif, centered
...
\entry{average temperature}{平均温度}
